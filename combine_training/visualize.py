...
def colormap_cityscapes(n):
    ...
    cmap[19,:] = np.array([ 255, 255, 32])
    cmap[20,:] = np.array([ 199, 0, 199])
    cmap[21,:] = np.array([ 0,  0,  0])
...
if __name__=='__main__':
        ...
        model = Segformer(combine_head=True)
        # print(model)
        pretrained_dict = torch.load("/mnt/ssd/home/tianxiaofeng/combine_training/lightning_logs/combined_decoder/checkpoints/epoch=99-step=27500.ckpt")['state_dict']
        ...
        image = Image.open('/mnt/hdd/dataset/woodscape/rgb_images/00000_FV.png')
        ...
        # print(inputs.items)
        # print(model.state)
        encoded_inputs = encoded_inputs.to(torch.device('cuda:3'))
        ...
        cv2.imwrite('./demo/inference.png',img)